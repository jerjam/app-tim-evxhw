...
//TODO: Dump* (Busca debug_printf)
/* API ERRORS */
#ifndef RESULT
#define RESULT int
#endif
#define GERR_MXC_RANGE 1
#define GERR_TRIGGER_RANGE 2
#define GERR_DBUS_BITS_RANGE 3
#define GERR_DBUS_SEL_MASK 4
#define GERR_SEQRAMS_RANGE 5
#define GERR_SEQRAMEV_RANGE 6
#define GERR_EVENT_CODE_RANGE 7
#define GERR_RAMSWTRIG_RANGE 8
#define GERR_UNIVIN_RANGE 9
...
RESULT EvgSeqRamSWTrig(volatile struct MrfEgRegs *pEg, int ram);
...
/// @name Defined by rsune
/// The following methods are NOT in the original MRF API.
/// @{
...
void EvgSetInternalFrac(volatile struct MrfEgRegs *pEg, int fracdiv); ///@todo its duplicating EvgSetFracDiv
